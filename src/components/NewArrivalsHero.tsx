  ...
  return (
    ...
    >
      ...
      <div className="container-luxury relative z-10 pt-28 pb-16 md:pt-36 md:pb-24 lg:pb-28">
        <nav className="na-crumb mb-12 text-[11px] tracking-[0.16em] text-muted uppercase md:mb-16">
        ...
        <div className="grid items-center gap-14 lg:grid-cols-12 lg:gap-10">
          <div className="lg:col-span-5">
            ...
            <div className="na-meta mt-14 flex flex-wrap items-center gap-x-8 gap-y-3 border-t border-border pt-6 text-[11px] tracking-[0.18em] text-muted uppercase">
              <span>
          ...
          <div className="na-media relative lg:col-span-7">
            <div className="relative mx-auto aspect-[4/5] max-w-[560px] lg:ml-auto lg:mr-0 lg:max-w-none lg:aspect-[5/6]">
              ...
              <div className="na-secondary absolute -bottom-6 -left-4 w-[42%] overflow-hidden rounded-[20px] border border-border shadow-[0_24px_60px_rgba(0,0,0,0.45)] md:-bottom-8 md:-left-8 md:w-[38%]">
