...
export function MaterialHero({ material, pieceCount }: MaterialHeroProps) {
  ...
  useGSAP(
    () => {
      ...
      tl.to(".mh-crumb", { autoAlpha: 1, y: 0, duration: 0.75 }, 0.12)
        ...
        <div className="grid items-center gap-14 lg:grid-cols-12 lg:gap-10">
          <div className="lg:col-span-5">
            ...
            <div className="mh-cta mt-10 flex flex-wrap gap-4">
              <a
                href="#material-grid"
                className="inline-flex h-[52px] items-center rounded-full bg-gold px-8 text-[12px] font-medium tracking-[0.16em] text-void uppercase transition-all duration-300 hover:-translate-y-0.5 hover:bg-gold-bright hover:shadow-gold"
              >
                Shop {meta.title.toLowerCase()}
              </a>
              <Link
                href="/collections/rings"
                className="inline-flex h-[52px] items-center rounded-full border border-border px-8 text-[12px] font-medium tracking-[0.16em] text-ink uppercase transition-all duration-300 hover:-translate-y-0.5 hover:border-gold hover:text-gold"
              >
                Browse rings
              </Link>
            </div>
          ...
          <div className="mh-media relative lg:col-span-7">
            <div className="relative mx-auto aspect-[4/5] max-w-[560px] lg:ml-auto lg:mr-0 lg:max-w-none lg:aspect-[5/6]">
              <div className="absolute inset-0 overflow-hidden shadow-lift">
                <Image
                  src={meta.image}
              ...
              <div className="mh-secondary absolute -right-3 -bottom-6 w-[44%] overflow-hidden border border-border shadow-lift sm:-right-6 sm:-bottom-8 md:w-[40%] lg:-right-4 lg:-bottom-10">
