...
/** Collapsed atelier section — promise ribbon + short craft story. */
export function AtelierPromise() {
  return (
    <section id="atelier" className="section-y border-t border-border bg-ivory">
      <div className="container-luxury">
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="reveal-item lg:col-span-5">
            <p className="label-caps mb-3">Atelier</p>
            <h2 className="font-display text-[clamp(2rem,4vw,3rem)] font-light leading-[1.08] tracking-[-0.02em] text-ink">
          ...
          <div className="reveal-image relative aspect-[4/5] overflow-hidden rounded-2xl lg:col-span-7 lg:aspect-[5/4]">
            <Image
